...
// 변수종류: var, let, const
// 변수작성문법 : 변수종류(var, let, const) 변수명 대입연산자 대입값;
// 기초 - 상황연습
// 1. 김치담을 반찬통 준비
let bowl; // 빈 변수
// 2. 김치 담기
...
//user_number = '222222-2222222'; //변경 시도 오류
console.log(user_number);

user_age = 20; //숫자로 인식하기 위해 따옴표 생략
console.log('20'+1); //201
console.log(20+1); //21
//올해 나이는 20, 내년 나이는 21
//변수로 저장한 데이터는 출력 시 변수로 사용해야함.
